    ...
    public class RdtPacker(BioVersion version, string hdrPath)
    {
        ...
        public void Pack()
        {
            try
            {
                ...
                MessageBox.Show($"{version} RDT repacked successfully!\n\nCheck for the repacked RDT file in this location:\n\n{TargetPath}", "Success!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
